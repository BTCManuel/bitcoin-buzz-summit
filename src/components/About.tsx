    ...
    <section id="about" className="py-32 bg-gradient-to-b from-black to-gray-900">
      <div className="container mx-auto px-4">
        <div className="max-w-3xl mx-auto text-center mb-20">
          ...
          <h2 className="text-4xl md:text-5xl font-bold mb-8 text-white">About the Conference</h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          {features.map((feature, index) => (
            <Card key={index} className="border-0 shadow-xl hover:shadow-2xl transition-all duration-300 hover:translate-y-[-5px] bg-gradient-to-br from-gray-800 to-gray-900 text-white rounded-2xl overflow-hidden">
