...
const Venue = () => {
  return (
    <section id="venue" className="py-32 bg-gray-50">
      <div className="container mx-auto px-4">
        <div className="max-w-3xl mx-auto text-center mb-16">
          <h2 className="text-4xl md:text-5xl font-bold mb-6">Venue Information</h2>
          ...
          <div className="space-y-8">
            <div>
              <h3 className="flex items-center text-2xl font-bold mb-4">
                <MapPin className="h-6 w-6 mr-3 text-bitcoin" />
                Location
              </h3>
            ...
            <div>
              <h3 className="flex items-center text-2xl font-bold mb-4">
                <Hotel className="h-6 w-6 mr-3 text-bitcoin" />
                Accommodations
              </h3>
              <p className="text-lg text-gray-600 mb-3">
                We've partnered with nearby hotels to offer special rates for conference attendees:
              </p>
              <ul className="list-disc list-inside text-lg text-gray-600 ml-2 space-y-2">
            ...
            <div>
              <h3 className="flex items-center text-2xl font-bold mb-4">
                <Info className="h-6 w-6 mr-3 text-bitcoin" />
